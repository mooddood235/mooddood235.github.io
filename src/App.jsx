...
function Skills(){
  const folderPath = '/skills_pictures';
    ...
    <div id='about'>
      <div id='about_content'>
        ...
        <div id='about_textblock'>
          ...
          <JetBrainsBold text=' web development'/>, and <JetBrainsBold text='programming languages'/>.
        </div>
      </div>
    </div>
  )
...
function Three({resources}){
  ...
  useEffect(()=>{  
    ...
    function render(timeStamp){
      ...
      const scrollT1 = MathUtils.clamp(window.scrollY / window.innerHeight * (5/3) - 2, 0.0, 1.0);
      ...
      if (scrollT0 === 1.0){
        ...
        camera.fov = lerp(60, 10, easeOut(Math.pow(scrollT1, 2.0)));
